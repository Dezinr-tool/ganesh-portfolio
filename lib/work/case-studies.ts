...
const DUMMY = {
  ...
  screen1: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1600&q=85&auto=format&fit=crop",
  screen2: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1600&q=85&auto=format&fit=crop",
  screen3: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=1600&q=85&auto=format&fit=crop",
  screen4: "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=1600&q=85&auto=format&fit=crop",
  screen5: "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=1600&q=85&auto=format&fit=crop",
  mobile: "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=900&q=85&auto=format&fit=crop",
  detail: "https://images.unsplash.com/photo-1551650975-87deedd944c3?w=1600&q=85&auto=format&fit=crop",
};
...
export function getMoreWorks(currentSlug: string) {
  return WORKS_PROJECTS.filter((project) => project.id !== currentSlug)
    .slice(0, 5)
    .map((project) => ({
      slug: project.id,
      title: project.title,
