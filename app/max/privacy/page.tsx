  ...
  return (
    <MaxShell>
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        <h1 className="mt-6 text-3xl font-light text-white">Privacy Policy</h1>
        ...
        <div className="mt-10 space-y-8 text-sm leading-relaxed text-zinc-400">
          ...
          <section>
            <h2 className="text-lg font-medium text-white">Your data stays yours</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-medium text-white">We do not sell your data</h2>
            <p className="mt-3">
          ...
          <section>
            ...
            <ul className="mt-4 list-inside list-disc space-y-2">
              <li>
                <strong className="text-zinc-300">Anthropic API</strong> — processes
                your chat messages and meeting transcripts to generate AI responses,
                summaries, and follow-up drafts.
              </li>
              <li>
                <strong className="text-zinc-300">Google Calendar</strong> — access
          ...
          <section>
            <h2 className="text-lg font-medium text-white">Cookies &amp; sessions</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-medium text-white">Data retention &amp; deletion</h2>
            <p className="mt-3">
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              <a
                href="mailto:ganeshdesigncraft@gmail.com"
