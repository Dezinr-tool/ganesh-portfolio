...
function DirectionSection({ direction }: { direction: MoodboardPresentationDirection }) {
  return (
...
export function PresentationView({
  ...
  const handleCopy = async () => {
    const md = presentationToMarkdown(directions, brandName);
  ...
  return (
    <div className="bg-white text-neutral-900">
      ...
      <div className="mx-auto max-w-5xl px-4 py-8 sm:px-8">
        {directions.map((dir) => (
          <div key={dir.id}>
            <DirectionSection direction={dir} />
